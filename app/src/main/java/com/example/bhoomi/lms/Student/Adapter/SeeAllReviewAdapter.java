...
public class SeeAllReviewAdapter extends RecyclerView.Adapter<SeeAllReviewAdapter.ViewHolder> {

    private ArrayList<RateInfo> dataSet;
    private Context context;

    public SeeAllReviewAdapter(Activity dashboard_activity, List<RateInfo> categoryModelArrayList) {
