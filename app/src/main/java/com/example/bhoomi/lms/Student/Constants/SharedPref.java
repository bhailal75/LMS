...
import com.example.bhoomi.lms.Activity.AppIntroducing_Activity;
...
public class SharedPref {
    ...
    public void checkLogin() {
        ...
        if (!this.isLoggedIn()) {
            ...
            Intent i = new Intent(_context, Welcome_Activity.class);
    ...
    public void logoutUser()
    {
        ...
        Intent i = new Intent(_context, AppIntroducing_Activity.class);
        // Closing all the Activities
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
