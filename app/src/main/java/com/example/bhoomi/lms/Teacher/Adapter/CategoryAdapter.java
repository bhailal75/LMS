...
public class CategoryAdapter extends ArrayAdapter<CategoryModel> {
    ...
    ArrayList<CategoryModel> data = null;
    CountryHolder countryHolder;

    public CategoryAdapter(Context listener, int simple_spinner_item, ArrayList<CategoryModel> countryList) {
    ...
    public View getDropDownView(int position, View convertView,  ViewGroup parent) {
        ...
        final CategoryModel item = data.get(position);
        ...
        countryHolder.textViewCountry.setText(item.getCat_name());
